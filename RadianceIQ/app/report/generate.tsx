    ...
    <AtmosphereScreen>
      <View style={styles.previewHeader}>
        <View>
          ...
          <Text style={styles.title}>RadianceIQ clinician export</Text>
        </View>
      ...
      <View style={styles.disclaimer}>
        <Text style={styles.disclaimerText}>
          Non-diagnostic metrics for clinician interpretation. Generated by RadianceIQ on {new Date().toISOString().split('T')[0]}.
        </Text>
      </View>
