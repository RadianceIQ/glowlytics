    ...
    <Svg width={200} height={160} viewBox="0 0 200 160">
      <Defs>
        <RadialGradient id="motionGlow" cx="50%" cy="50%" r="50%">
          <Stop offset="0%" stopColor="#8A95FF" stopOpacity={0.8} />
          <Stop offset="55%" stopColor="#8A95FF" stopOpacity={0.2} />
      ...
      <Line x1={45} y1={55} x2={70} y2={60} stroke="#8A95FF" strokeWidth={2} strokeOpacity={0.5} strokeLinecap="round" />
      <Line x1={40} y1={75} x2={65} y2={78} stroke="#8A95FF" strokeWidth={1.5} strokeOpacity={0.4} strokeLinecap="round" />
      <Line x1={48} y1={95} x2={72} y2={95} stroke="#7DE7E1" strokeWidth={1.5} strokeOpacity={0.35} strokeLinecap="round" />
      <Line x1={130} y1={58} x2={155} y2={55} stroke="#8A95FF" strokeWidth={2} strokeOpacity={0.45} strokeLinecap="round" />
      <Line x1={135} y1={78} x2={160} y2={76} stroke="#7DE7E1" strokeWidth={1.5} strokeOpacity={0.35} strokeLinecap="round" />
      <Line x1={128} y1={98} x2={152} y2={96} stroke="#8A95FF" strokeWidth={1.5} strokeOpacity={0.3} strokeLinecap="round" />
      {/* Dynamic arc paths */}
      <Path
      ...
      />
      {/* Orbital ring */}
      <Circle cx={100} cy={80} r={38} fill="none" stroke="#8A95FF" strokeWidth={1} strokeOpacity={0.2} />
      {/* Core energy */}
      <Circle cx={100} cy={80} r={18} fill="url(#coreEnergy)" />
      <Circle cx={100} cy={80} r={6} fill="#8A95FF" fillOpacity={0.85} />
      {/* Accent particles */}
      <Circle cx={58} cy={42} r={2.5} fill="#8A95FF" fillOpacity={0.5} />
      <Circle cx={148} cy={45} r={2} fill="#7DE7E1" fillOpacity={0.4} />
      <Circle cx={55} cy={115} r={2} fill="#7DE7E1" fillOpacity={0.3} />
      <Circle cx={150} cy={110} r={3} fill="#8A95FF" fillOpacity={0.35} />
    </Svg>
  );
}
