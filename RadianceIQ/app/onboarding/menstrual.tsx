    ...
    <Svg width={180} height={160} viewBox="0 0 180 160">
      <Defs>
        <RadialGradient id="amberCenter" cx="50%" cy="50%" r="50%">
          <Stop offset="0%" stopColor="#F2B56A" stopOpacity={0.45} />
          <Stop offset="60%" stopColor="#F2B56A" stopOpacity={0.1} />
          <Stop offset="100%" stopColor="#F2B56A" stopOpacity={0} />
        </RadialGradient>
        <RadialGradient id="tealRim" cx="50%" cy="50%" r="50%">
          <Stop offset="0%" stopColor="#7DE7E1" stopOpacity={0.3} />
      ...
      {/* Wave circles */}
      <Circle cx={90} cy={80} r={55} fill="none" stroke="#7DE7E1" strokeWidth={0.7} strokeOpacity={0.12} />
      <Circle cx={90} cy={80} r={45} fill="none" stroke="#F2B56A" strokeWidth={0.8} strokeOpacity={0.18} />
      <Circle cx={90} cy={80} r={35} fill="none" stroke="#7DE7E1" strokeWidth={0.9} strokeOpacity={0.2} />
      <Circle cx={90} cy={80} r={25} fill="none" stroke="#F2B56A" strokeWidth={1} strokeOpacity={0.25} />
      {/* Amber center glow */}
      ...
      />
      {/* Center dot */}
      <Circle cx={90} cy={80} r={5} fill="#F2B56A" fillOpacity={0.55} />
      <Circle cx={90} cy={80} r={2} fill="#F2B56A" fillOpacity={0.8} />
      {/* Phase dots around the circle */}
      <Circle cx={90} cy={25} r={3} fill="#F2B56A" fillOpacity={0.3} />
      <Circle cx={145} cy={80} r={3} fill="#7DE7E1" fillOpacity={0.25} />
      <Circle cx={90} cy={135} r={3} fill="#F2B56A" fillOpacity={0.3} />
      <Circle cx={35} cy={80} r={3} fill="#7DE7E1" fillOpacity={0.25} />
    </Svg>
  );
}
